...
# ---------------- Page Config ----------------
st.set_page_config(page_title="GPS & Data Visualization Tool", page_icon="🌍", layout="wide")
...
st.markdown('<div class="subtitle">Upload your dataset and generate interactive maps instantly 🚀</div>', unsafe_allow_html=True)
...
if uploaded_file:
    with st.spinner("⏳ Processing your file... Please wait."):
        ...
        if lat_col and lon_col:
            visualize_map = st.checkbox("🗺️ Visualize map using GPS coordinates?")
        else:
            st.info("⚠️ GPS coordinates columns not found. Map visualization not available.")
            ...
            with st.spinner("⚙️ Generating visualizations..."):
                if len(group_vars) == 0:
                    ...
                    if visualize_map and lat_col and lon_col:
                        ...
                        st.warning("⚠️ Map visualization skipped or unavailable. Showing grouping summary instead.")
